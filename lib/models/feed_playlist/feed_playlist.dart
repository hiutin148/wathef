...
part 'feed_playlist.g.dart';

@JsonSerializable()
class FeedPlaylist extends Equatable {
  final String? id;
  final Title? title;
  final String? link;
  ...
  factory FeedPlaylist.fromJson(Map<String, dynamic> json) =>
      _$FeedPlaylistFromJson(json);
  Map<String, dynamic> toJson() => _$FeedPlaylistToJson(this);
